...
const uint8_t font6x8[][6] = {
		...
		,{0x00, 0x00, 0x00, 0x5E, 0x00, 0x00} // 7d }	//missed call icon in call logs
		,{0x00, 0x20, 0x10, 0x0A, 0x06, 0x0E} // 7e ->	//outgoing call icon in call logs
		,{0x00, 0x38, 0x30, 0x28, 0x04, 0x02} // 7f <-	//incoming call icon in call logs
};

const uint8_t font12x16[][12] = {
		...
		,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00},    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x67, 0x67, 0x00, 0x00, 0x00, 0x00} // 21 !
		,{0x00, 0x00, 0xFF, 0xFF, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x7E, 0x3C},    {0x00, 0x00, 0x7F, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // 22 " -> P
		,{0x00, 0x60, 0x60, 0x60, 0xE0, 0xF0, 0x7C, 0x6C, 0xE0, 0xF0, 0x7C, 0x6C},    {0x00, 0x36, 0x3E, 0x0F, 0x07, 0x36, 0x3E, 0x0F, 0x07, 0x06, 0x06, 0x06} // 23 #
		...
		,{0x00, 0x00, 0x30, 0x60, 0xC0, 0x80, 0xFC, 0xFC, 0x80, 0xC0, 0x60, 0x30},    {0x00, 0x00, 0x0C, 0x06, 0x03, 0x01, 0x3F, 0x3F, 0x01, 0x03, 0x06, 0x0C} // 2a *
		,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // 2b
		,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // 2c
		,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},    {0x00, 0x00, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40} // 2d _ instead of '-'
		,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},    {0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x78, 0x78, 0x78, 0x00, 0x00, 0x00} // 2e .
		,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0xC0, 0x60, 0x30, 0x18, 0x0C},	  {0x00, 0x00, 0x18, 0x0C, 0x06, 0x03, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00} // 2f /
		,{0x00, 0x00, 0xFC, 0xFE, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0xFE, 0xFC},    {0x00, 0x00, 0x1F, 0x3F, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x3F, 0x1F} // 30 0
		,{0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00},    {0x00, 0x00, 0x00, 0x00, 0x60, 0x60, 0x7F, 0x7F, 0x60, 0x60, 0x00, 0x00} // 31 1
		,{0x00, 0x00, 0x1C, 0x1E, 0x03, 0x03, 0x03, 0x03, 0x83, 0xC3, 0x7E, 0x3C},    {0x00, 0x00, 0x60, 0x70, 0x78, 0x6C, 0x66, 0x63, 0x61, 0x60, 0x60, 0x60} // 32 2
		,{0x00, 0x00, 0x0C, 0x0E, 0x03, 0x03, 0x03, 0xC3, 0xC3, 0xC3, 0xFE, 0x3C},    {0x00, 0x00, 0x18, 0x38, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x3F, 0x1F} // 33 3
		,{0x00, 0x00, 0x00, 0x80, 0xC0, 0x60, 0x30, 0x18, 0x0C, 0xFE, 0xFF, 0x00},    {0x00, 0x00, 0x07, 0x07, 0x06, 0x06, 0x06, 0x06, 0x06, 0x7F, 0x7F, 0x06} // 34 4
		,{0x00, 0x00, 0x3F, 0x7F, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0xC3, 0x83},    {0x00, 0x00, 0x18, 0x38, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x3F, 0x1F} // 35 5
		,{0x00, 0x00, 0xFC, 0xFE, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x83, 0x00},    {0x00, 0x00, 0x1F, 0x3F, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x3F, 0x1F} // 36 6
		,{0x00, 0x00, 0x03, 0x03, 0x03, 0x03, 0x03, 0x83, 0xE3, 0x7B, 0x1F, 0x07},    {0x00, 0x00, 0x00, 0x00, 0x60, 0x78, 0x1E, 0x07, 0x01, 0x00, 0x00, 0x00} // 37 7
		,{0x00, 0x00, 0x3C, 0xFE, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xFE, 0x3C},    {0x00, 0x00, 0x1F, 0x3F, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x3F, 0x1F} // 38 8
		,{0x00, 0x00, 0x3C, 0x7E, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xFE, 0xFC},    {0x00, 0x00, 0x00, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x3F, 0x1F} // 39 9
		,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00, 0x00},    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x0C, 0x00, 0x00, 0x00, 0x00} // 3a :
	//	,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // 3b
	//	,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // 3c
	//	,{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} // 3d
/*

 

DB     0H,0H,0H,0H,0FFH,7FH,0FFH,7FH,0C3H,0H,0C3H,0H,	0C3H,0H,0C3H,0H,0C3H,0H,0C3H,0H,7EH,0H,3CH,0H  
